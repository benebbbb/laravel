    ...
    <div class="col-sm-6 col-xl-3">
        <div class="card stat-card shadow-sm h-100">
            <div class="card-body d-flex align-items-center gap-3">
                ...
                <div>
                    <div class="text-muted small">My Medicines</div>
                    <div class="fs-4 fw-bold">{{ $totalMedicines }}</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card stat-card shadow-sm h-100">
            <div class="card-body d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <div class="fs-4 fw-bold">{{ $expired }}</div>
                </div>
            </div>
        </div>
    </div>
